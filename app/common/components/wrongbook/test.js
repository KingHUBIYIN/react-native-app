...
var HomeListView = React.createClass({
    ...
    _onChoiceAll:function(e,name,toggle){
//        History.pushRoute("/wrong/index/" +this.props.subject + "/ChoiceAll?toggle="+toggle );
	},
    render:function(){
                        ...
                        <View style ={{backgroundColor: "#fff"}}>
                            <View style = {styles.titleText}>
                                <View style = {[styles.titleSelect,styles.bordStyle]}>
                                        <TouchableOpacity onPress = {this._onWrongChoiceAll}><View style={{marginRight:Dimensions.size["4"]}}><Text style = {styles.textSize}>全部</Text></View></TouchableOpacity>
                                        <ToggleButton icon={btn_drop_down} toggleIcon={btn_drop_up} style={styles.next} iconHeight={Dimensions.size["8"]} iconWidth={Dimensions.size["8"]} onPress={this._onChoiceAll}/>
                                </View>
                               
                                <View style = {styles.titleSelect}>
                                        <TouchableOpacity onPress = {this._onWrongChoiceChapter}><View style={{marginRight:Dimensions.size["4"]}}><Text style = {styles.textSize}>章节</Text></View></TouchableOpacity>
                                        <ToggleButton icon={btn_drop_down} toggleIcon={btn_drop_up} style={styles.next} iconHeight={Dimensions.size["8"]} iconWidth={Dimensions.size["8"]} onPress={this._onChoiceChapter}/>
                                </View>
